...
class AllHistoryChartView @JvmOverloads constructor(
    ...
    private fun initChart() {
        ...
        // no description text
        allHistoryPieChart.getDescription().setEnabled(false)
        ...
        val x: XAxis = allHistoryPieChart.getXAxis()
        x.isEnabled = false
        val y: YAxis = allHistoryPieChart.getAxisLeft()
        //y.typeface = tfLight
        ...
        allHistoryPieChart.getAxisRight().setEnabled(false)

        allHistoryPieChart.getLegend().setEnabled(false)
